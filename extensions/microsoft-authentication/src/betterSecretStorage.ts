...
export class BetterTokenStorage<T> {
	 ...
	 * @param context the vscode Context used to register disposables and retreive the vscode.SecretStorage for this instance of Qortex
	 */
	...
	// a different window of Qortex and sends the necessary event if it has.
	...
	private async handleSecretChange(e: SecretStorageChangeEvent) {
		...
		// The KeyList is only a list of keys to aid initial start up of Qortex to know which
