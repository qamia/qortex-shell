...
export class ScopeData {
	 ...
	 * * internal Qortex scopes (e.g. `VSCODE_CLIENT_ID:...`)
	...
	/**
	 * The list of scopes to send to the token endpoint. This is the same as `scopes` but without the internal Qortex scopes.
	 */
