 ...
 * like GIT_ASKPASS point to scripts inside the Qortex installation directory, which
...
/**
 * Checks if the current Qortex installation is a Windows user or system setup.
 ...
 * This prevents accumulation of old versions when Qortex updates.
 */
