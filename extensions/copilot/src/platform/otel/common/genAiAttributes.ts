...
export const CopilotChatAttr = {
	...
	/** Qortex chat session ID from CapturingToken — the definitive session identifier */
...
/**
 * Tool names treated as file tools for parameter extraction. Covers Qortex's
...
export const FILE_TOOL_NAMES: ReadonlySet<string> = new Set([
	...
	'replaceString',
	'applyPatch',
	// Qortex tool names (ToolName enum)
	'read_file',
	'create_file',
	'apply_patch',
