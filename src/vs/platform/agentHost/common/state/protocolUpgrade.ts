 ...
 * by the Qortex CLI, asks the CLI to check for a server upgrade and
 ...
 * data payload. Servers that are spawned by the Qortex CLI populate this
 ...
 * extension used by Qortex-hosted agent hosts.
 *
