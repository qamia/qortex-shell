...
// (synced from the agent-host-protocol repo). This file adds Qortex-specific
...
/**
 * Qortex-side alias for the protocol's open `_meta` property bag on
 ...
 * {@link ISessionGitState}. This is a Qortex-specific convention layered
