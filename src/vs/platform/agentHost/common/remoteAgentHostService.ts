...
export type RemoteAgentHostConnectionStatus =
	...
	| {
		 ...
		 * Set only when the server was spawned by a Qortex CLI willing
...
export interface IRemoteAgentHostSSHConnection {
	 ...
	 * client connects to, and is used to construct the Qortex Remote
...
export interface IRemoteAgentHostTunnelConnection {
	 ...
	 * Used as the tunnel name in the Qortex Remote Tunnels authority
