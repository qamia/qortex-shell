...
class ElementPicker {
	...
	private static readonly _CURSOR_DEFAULT = '/* Qortex injected style */ * { cursor: default !important; }';
	private static readonly _CURSOR_CROSSHAIR = '/* Qortex injected style */ * { cursor: crosshair !important; }';
