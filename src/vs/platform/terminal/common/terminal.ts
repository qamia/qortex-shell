...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit Qortex's "shell environment" that may
	 ...
	 * a terminal used to drive some Qortex feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to Qortex and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** Qortex shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}
