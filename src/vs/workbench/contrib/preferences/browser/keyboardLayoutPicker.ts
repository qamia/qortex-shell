...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Qortex in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Qortex and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
