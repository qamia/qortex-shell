...
/**
 * Allows webviews to monitor when an element in the Qortex editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. Qortex needs to see this
