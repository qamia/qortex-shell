...
/**
 * Builds a redirect URL that GitHub will use to return the user to Qortex
 ...
 * @param urlProtocol The Qortex URL protocol scheme (e.g. `vscode`, `vscode-insiders`, `code-oss`).
