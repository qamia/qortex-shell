 ...
 *
 * The default (core) registration exposes a single "Qortex" harness
...
export interface ICustomizationHarnessService {
	 ...
	 * Qortex harness falls back to the core prompts service.
	 *
	 ...
	 * Provider-backed harnesses resolve their own items directly; the default Qortex harness falls back to the core prompts service.
	 *
	 * @param sessionResource URI of the chat session whose customizations
...
/**
 * Creates a "Qortex" harness descriptor that shows all storage sources
