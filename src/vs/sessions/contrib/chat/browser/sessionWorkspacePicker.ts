...
export class WorkspacePicker extends Disposable {
	...
	/** Cached Qortex recent folder URIs, resolved lazily. */
	...
	constructor(
		...
		// Load Qortex recent folders eagerly and refresh on changes
	 ...
	 * without source grouping. Own recents come first, followed by Qortex
	 * recent folders.
	 */
	protected _buildItems(): IActionListItem<IWorkspacePickerItem>[] {
		...
		// Merge Qortex recent folders (resolved through providers, deduplicated)
	...
	/**
	 * Returns Qortex recent folders resolved through registered session
